    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('dashboard.categorys.index') }}">@lang('site.categorys')</a></li>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.categorys.update', $categorys->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" class="form-control" value="{{ $categorys->first_name }}"
                            placeholder="First Name">
                    </div>
                    <div class="form-group">
                        <label>@lang('site.last_name')</label>
                        <input type="text" name="last_name" class="form-control" value="{{ $categorys->last_name }}"
                            placeholder="Last Name">
                    </div>
                    <div class="form-group">
                        <label>@lang('site.email')</label>
                        <input type="email" name="email" class="form-control" value="{{ $categorys->email }}"
                            placeholder="Email">
                    </div>
                    <div class="form-group">
                        <!--    Image      -->
                    ...
                    <div class="form-group">
                        <img style="width: 100px" class="img-thumbnail image-preview" src="{{ $categorys->image_path }}">
                    </div>
                                        ...
                                        <div class="tab-pane {{ $index == 0 ? 'active' : '' }}" id="{{ $tap }}">
                                            @foreach ($cruds as $crud)
                                                ...
                                                <label class="mr-2" style="font-weight: 400;"><input
                                                        ...
                                                        {{ $categorys->hasPermission($tap . '_' . $crud) ? 'checked' : '' }}
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary "><i
                                class="fa fa-category-edit mr-1"></i>@lang('site.edit')</button>
                        {{-- <button type="submit" class="btn btn-danger" onclick="{{ route('dashboard.categorys.index') }}"><i
